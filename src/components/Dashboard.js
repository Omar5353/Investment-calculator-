...
export default function Dashboard({ summary, incomeData, expenseData }) {
  const {
    ...
    <div>
      <div className="dashboard-kpis">
        {[
          ...
          { label: 'Monthly Surplus', value: fmt$(monthlySurplus), color: monthlySurplus >= 0 ? 'teal' : 'red', sub: 'after expenses & taxes' },
